  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formbox}>
        ...
        <Text style = {{fontFamily: 'montserrat',fontWeight: 'bold',fontSize: 14,marginTop: 25,}}>Don't have an account yet?</Text>
        <TouchableOpacity onPress={SignIn}>
          <Text style={{fontFamily: 'montserrat',fontWeight: 'bold',fontSize: 14, color:'#4A1BAC', textDecorationLine: 'underline',paddingTop: 25}}>Sign Up</Text>
        </TouchableOpacity>
