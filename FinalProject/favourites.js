...
import {  getFavoriteProductIdsByUserId } from './Database';
...
const FavouritesPage = ({ navigation }) => {
  ...
  const navtodescription = async (productId) => {
    console.log(productId);
    navigation.navigate('description', { userId: userID, product: productId });
  };
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <ScrollView>
              ...
              {products.map((product, index) => (
                <View key={index} style={styles.productbox}>
                 <TouchableOpacity>
                  ...
                  <TouchableOpacity onPress={navtodescription} style={styles.addtocartbtn}>
                  <Text style={styles.settingbuttontext2 }>View Product</Text>
                  </TouchableOpacity>
            ...
            <TouchableOpacity onPress={gotocart} style={styles.settingbuttons2}>
